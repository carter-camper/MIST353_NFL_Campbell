...
def schedule_game_ui():
    ...
    HomeTeamID = st.number_input("Enter Home Team ID:", min_value=1, step=1)
    AwayTeamID = st.number_input("Enter Away Team ID:", min_value=1, step=1)
    ...
    StadiumID = st.number_input("Enter Stadium ID:", min_value=1, step=1)
    NFLAdminID = st.number_input("Enter NFL Admin ID:", min_value=1, step=1)
