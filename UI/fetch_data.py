...
FASTAPI_URL = "https://mist353-api-campbell.azurewebsites.net"
#"http://localhost:8000"
...
def post_data(endpoint: str, input_params: dict, method: str = "POST"):
    if method == "POST":
        ...
        if response.status_code == 200:
            ...
            return {"status_message": f"Error Occured: {response.status_code}"}